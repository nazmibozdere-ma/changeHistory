...
export const storefrontOptions = ['United States', 'United Kingdom', 'Germany', 'European Union', 'Global'];
...
export const campaignGroups: CampaignGroupInfo[] = [
  {
    ...
    campaigns: [
      { id: 'c1', name: 'Casino_US_Brand', status: 'active', appId: 'a1', storefront: 'United States', adGroups: [
        { id: 'ag30', name: 'us_slots_exact_match_brand_terms', status: 'active' },
        { id: 'ag31', name: 'us_casino_competitor_broad_match', status: 'active' },
        { id: 'ag32', name: 'us_jackpot_high_intent_search_queries', status: 'paused' },
        { id: 'ag33', name: 'us_casino_phrase_match_general_terms', status: 'active' },
        { id: 'ag34', name: 'us_slots_exact_match_brand_terms', status: 'active' },
        { id: 'ag35', name: 'us_casino_competitor_broad_match', status: 'paused' },
        { id: 'ag36', name: 'us_jackpot_high_intent_search_queries', status: 'active' },
        { id: 'ag37', name: 'us_casino_phrase_match_general_terms', status: 'active' },
        { id: 'ag38', name: 'us_slots_exact_match_brand_terms', status: 'paused' },
        { id: 'ag39', name: 'us_casino_competitor_broad_match', status: 'active' },
      ]},
      { id: 'c2', name: 'Casino_EU_Broad', status: 'paused', appId: 'a2', storefront: 'European Union', adGroups: [
        { id: 'ag40', name: 'eu_casino_broad_keywords_general', status: 'active' },
        { id: 'ag41', name: 'eu_slots_phrase_match_international', status: 'paused' },
        { id: 'ag42', name: 'eu_casino_broad_keywords_general', status: 'active' },
        { id: 'ag43', name: 'eu_slots_phrase_match_international', status: 'active' },
        { id: 'ag44', name: 'eu_casino_broad_keywords_general', status: 'paused' },
        { id: 'ag45', name: 'eu_slots_phrase_match_international', status: 'active' },
        { id: 'ag46', name: 'eu_casino_broad_keywords_general', status: 'active' },
        { id: 'ag47', name: 'eu_slots_phrase_match_international', status: 'paused' },
        { id: 'ag48', name: 'eu_casino_broad_keywords_general', status: 'active' },
        { id: 'ag49', name: 'eu_slots_phrase_match_international', status: 'active' },
      ]},
      { id: 'c3', name: 'Casino_Slots_Retargeting', status: 'active', appId: 'a3', storefront: 'Global', adGroups: [
        { id: 'ag50', name: 'retargeting_lapsed_users_7days', status: 'paused' },
        { id: 'ag51', name: 'retargeting_high_value_lookalike', status: 'active' },
        { id: 'ag52', name: 'retargeting_lapsed_users_7days', status: 'active' },
        { id: 'ag53', name: 'retargeting_high_value_lookalike', status: 'paused' },
        { id: 'ag54', name: 'retargeting_lapsed_users_7days', status: 'active' },
        { id: 'ag55', name: 'retargeting_high_value_lookalike', status: 'active' },
        { id: 'ag56', name: 'retargeting_lapsed_users_7days', status: 'paused' },
        { id: 'ag57', name: 'retargeting_high_value_lookalike', status: 'active' },
        { id: 'ag58', name: 'retargeting_lapsed_users_7days', status: 'active' },
        { id: 'ag59', name: 'retargeting_high_value_lookalike', status: 'paused' },
      ]},
      { id: 'c4', name: 'Casino_High_Value_Users', status: 'active', appId: 'a1', storefront: 'United States', adGroups: [
        { id: 'ag60', name: 'vip_exact_match_core_terms', status: 'active' },
        { id: 'ag61', name: 'whale_audience_broad_targeting', status: 'active' },
        { id: 'ag62', name: 'vip_exact_match_core_terms', status: 'paused' },
        { id: 'ag63', name: 'whale_audience_broad_targeting', status: 'active' },
        { id: 'ag64', name: 'vip_exact_match_core_terms', status: 'active' },
        { id: 'ag65', name: 'whale_audience_broad_targeting', status: 'paused' },
        { id: 'ag66', name: 'vip_exact_match_core_terms', status: 'active' },
        { id: 'ag67', name: 'whale_audience_broad_targeting', status: 'active' },
        { id: 'ag68', name: 'vip_exact_match_core_terms', status: 'paused' },
        { id: 'ag69', name: 'whale_audience_broad_targeting', status: 'active' },
      ]},
      { id: 'c5', name: 'Casino_UK_Exact', status: 'paused', appId: 'a2', storefront: 'United Kingdom', adGroups: [
        { id: 'ag70', name: 'uk_brand_exact_core_casino_terms', status: 'active' },
        { id: 'ag71', name: 'uk_slots_exact_competitor_keywords', status: 'paused' },
        { id: 'ag72', name: 'uk_brand_exact_core_casino_terms', status: 'active' },
        { id: 'ag73', name: 'uk_slots_exact_competitor_keywords', status: 'active' },
        { id: 'ag74', name: 'uk_brand_exact_core_casino_terms', status: 'paused' },
        { id: 'ag75', name: 'uk_slots_exact_competitor_keywords', status: 'active' },
        { id: 'ag76', name: 'uk_brand_exact_core_casino_terms', status: 'active' },
        { id: 'ag77', name: 'uk_slots_exact_competitor_keywords', status: 'paused' },
        { id: 'ag78', name: 'uk_brand_exact_core_casino_terms', status: 'active' },
        { id: 'ag79', name: 'uk_slots_exact_competitor_keywords', status: 'active' },
      ]},
    ],
  },
  {
    ...
    campaigns: [
      { id: 'c6', name: 'Android_US_Brand', status: 'active', appId: 'a4', storefront: 'United States', adGroups: [
        { id: 'ag80', name: 'android_us_brand_exact_match', status: 'paused' },
        { id: 'ag81', name: 'android_us_competitor_broad_match', status: 'active' },
        { id: 'ag82', name: 'android_us_slots_high_intent', status: 'active' },
        { id: 'ag83', name: 'android_us_brand_exact_match', status: 'paused' },
        { id: 'ag84', name: 'android_us_competitor_broad_match', status: 'active' },
        { id: 'ag85', name: 'android_us_slots_high_intent', status: 'active' },
        { id: 'ag86', name: 'android_us_brand_exact_match', status: 'paused' },
        { id: 'ag87', name: 'android_us_competitor_broad_match', status: 'active' },
        { id: 'ag88', name: 'android_us_slots_high_intent', status: 'active' },
        { id: 'ag89', name: 'android_us_brand_exact_match', status: 'paused' },
      ]},
      { id: 'c7', name: 'Android_Broad_Match', status: 'paused', appId: 'a5', storefront: 'Global', adGroups: [
        { id: 'ag90', name: 'android_broad_casino_general_terms', status: 'active' },
        { id: 'ag91', name: 'android_broad_slots_phrase_match', status: 'active' },
        { id: 'ag92', name: 'android_broad_casino_general_terms', status: 'paused' },
        { id: 'ag93', name: 'android_broad_slots_phrase_match', status: 'active' },
        { id: 'ag94', name: 'android_broad_casino_general_terms', status: 'active' },
        { id: 'ag95', name: 'android_broad_slots_phrase_match', status: 'paused' },
        { id: 'ag96', name: 'android_broad_casino_general_terms', status: 'active' },
        { id: 'ag97', name: 'android_broad_slots_phrase_match', status: 'active' },
        { id: 'ag98', name: 'android_broad_casino_general_terms', status: 'paused' },
        { id: 'ag99', name: 'android_broad_slots_phrase_match', status: 'active' },
      ]},
      { id: 'c8', name: 'Android_Remarketing', status: 'active', appId: 'a6', storefront: 'Global', adGroups: [
        { id: 'ag100', name: 'android_retargeting_lapsed_30days', status: 'active' },
        { id: 'ag101', name: 'android_retargeting_vip_users_exact', status: 'paused' },
        { id: 'ag102', name: 'android_retargeting_lapsed_30days', status: 'active' },
        { id: 'ag103', name: 'android_retargeting_vip_users_exact', status: 'active' },
        { id: 'ag104', name: 'android_retargeting_lapsed_30days', status: 'paused' },
        { id: 'ag105', name: 'android_retargeting_vip_users_exact', status: 'active' },
        { id: 'ag106', name: 'android_retargeting_lapsed_30days', status: 'active' },
        { id: 'ag107', name: 'android_retargeting_vip_users_exact', status: 'paused' },
        { id: 'ag108', name: 'android_retargeting_lapsed_30days', status: 'active' },
        { id: 'ag109', name: 'android_retargeting_vip_users_exact', status: 'active' },
      ]},
      { id: 'c9', name: 'Android_Competitor_KW', status: 'active', appId: 'a4', storefront: 'United States', adGroups: [
        { id: 'ag110', name: 'android_competitor_brand_exact', status: 'paused' },
        { id: 'ag111', name: 'android_competitor_generic_broad', status: 'active' },
        { id: 'ag112', name: 'android_competitor_brand_exact', status: 'active' },
        { id: 'ag113', name: 'android_competitor_generic_broad', status: 'paused' },
        { id: 'ag114', name: 'android_competitor_brand_exact', status: 'active' },
        { id: 'ag115', name: 'android_competitor_generic_broad', status: 'active' },
        { id: 'ag116', name: 'android_competitor_brand_exact', status: 'paused' },
        { id: 'ag117', name: 'android_competitor_generic_broad', status: 'active' },
        { id: 'ag118', name: 'android_competitor_brand_exact', status: 'active' },
        { id: 'ag119', name: 'android_competitor_generic_broad', status: 'paused' },
      ]},
    ],
  },
  {
    ...
    campaigns: [
      { id: 'c10', name: 'EU_Brand_iOS', status: 'active', appId: 'a9', storefront: 'European Union', adGroups: [
        { id: 'ag120', name: 'eu_ios_brand_exact_match_terms', status: 'active' },
        { id: 'ag121', name: 'eu_ios_slots_phrase_match_broad', status: 'active' },
        { id: 'ag122', name: 'eu_ios_brand_exact_match_terms', status: 'paused' },
        { id: 'ag123', name: 'eu_ios_slots_phrase_match_broad', status: 'active' },
        { id: 'ag124', name: 'eu_ios_brand_exact_match_terms', status: 'active' },
        { id: 'ag125', name: 'eu_ios_slots_phrase_match_broad', status: 'paused' },
        { id: 'ag126', name: 'eu_ios_brand_exact_match_terms', status: 'active' },
        { id: 'ag127', name: 'eu_ios_slots_phrase_match_broad', status: 'active' },
        { id: 'ag128', name: 'eu_ios_brand_exact_match_terms', status: 'paused' },
        { id: 'ag129', name: 'eu_ios_slots_phrase_match_broad', status: 'active' },
      ]},
      { id: 'c11', name: 'EU_Retargeting', status: 'active', appId: 'a7', storefront: 'European Union', adGroups: [
        { id: 'ag130', name: 'eu_retargeting_lapsed_users_14days', status: 'active' },
        { id: 'ag131', name: 'eu_retargeting_high_value_exact', status: 'paused' },
        { id: 'ag132', name: 'eu_retargeting_lapsed_users_14days', status: 'active' },
        { id: 'ag133', name: 'eu_retargeting_high_value_exact', status: 'active' },
        { id: 'ag134', name: 'eu_retargeting_lapsed_users_14days', status: 'paused' },
        { id: 'ag135', name: 'eu_retargeting_high_value_exact', status: 'active' },
        { id: 'ag136', name: 'eu_retargeting_lapsed_users_14days', status: 'active' },
        { id: 'ag137', name: 'eu_retargeting_high_value_exact', status: 'paused' },
        { id: 'ag138', name: 'eu_retargeting_lapsed_users_14days', status: 'active' },
        { id: 'ag139', name: 'eu_retargeting_high_value_exact', status: 'active' },
      ]},
      { id: 'c12', name: 'UK_Exact_Match', status: 'paused', appId: 'a8', storefront: 'United Kingdom', adGroups: [
        { id: 'ag140', name: 'uk_brand_exact_core_terms', status: 'paused' },
        { id: 'ag141', name: 'uk_casino_exact_competitor_kw', status: 'active' },
        { id: 'ag142', name: 'uk_brand_exact_core_terms', status: 'active' },
        { id: 'ag143', name: 'uk_casino_exact_competitor_kw', status: 'paused' },
        { id: 'ag144', name: 'uk_brand_exact_core_terms', status: 'active' },
        { id: 'ag145', name: 'uk_casino_exact_competitor_kw', status: 'active' },
        { id: 'ag146', name: 'uk_brand_exact_core_terms', status: 'paused' },
        { id: 'ag147', name: 'uk_casino_exact_competitor_kw', status: 'active' },
        { id: 'ag148', name: 'uk_brand_exact_core_terms', status: 'active' },
        { id: 'ag149', name: 'uk_casino_exact_competitor_kw', status: 'paused' },
      ]},
      { id: 'c13', name: 'DE_Broad_Search', status: 'active', appId: 'a7', storefront: 'Germany', adGroups: [
        { id: 'ag150', name: 'de_broad_casino_german_keywords', status: 'active' },
        { id: 'ag151', name: 'de_broad_slots_general_terms', status: 'active' },
        { id: 'ag152', name: 'de_broad_casino_german_keywords', status: 'paused' },
        { id: 'ag153', name: 'de_broad_slots_general_terms', status: 'active' },
        { id: 'ag154', name: 'de_broad_casino_german_keywords', status: 'active' },
        { id: 'ag155', name: 'de_broad_slots_general_terms', status: 'paused' },
        { id: 'ag156', name: 'de_broad_casino_german_keywords', status: 'active' },
        { id: 'ag157', name: 'de_broad_slots_general_terms', status: 'active' },
        { id: 'ag158', name: 'de_broad_casino_german_keywords', status: 'paused' },
        { id: 'ag159', name: 'de_broad_slots_general_terms', status: 'active' },
      ]},
    ],
  },
];
