...
export const campaignGroups: CampaignGroupInfo[] = [
  {
    ...
    campaigns: [
      { id: 'c1', name: 'Casino_US_Brand', status: 'active', appId: 'a1', adGroups: [
        { id: 'ag30', name: 'us_slots_exact_match_brand_terms' },
        { id: 'ag31', name: 'us_casino_competitor_broad_match' },
        { id: 'ag32', name: 'us_jackpot_high_intent_search_queries' },
        { id: 'ag33', name: 'us_casino_phrase_match_general_terms' },
        { id: 'ag34', name: 'us_slots_exact_match_brand_terms' },
        { id: 'ag35', name: 'us_casino_competitor_broad_match' },
        { id: 'ag36', name: 'us_jackpot_high_intent_search_queries' },
        { id: 'ag37', name: 'us_casino_phrase_match_general_terms' },
        { id: 'ag38', name: 'us_slots_exact_match_brand_terms' },
        { id: 'ag39', name: 'us_casino_competitor_broad_match' },
      ]},
      { id: 'c2', name: 'Casino_EU_Broad', status: 'paused', appId: 'a2', adGroups: [
        { id: 'ag40', name: 'eu_casino_broad_keywords_general' },
        { id: 'ag41', name: 'eu_slots_phrase_match_international' },
        { id: 'ag42', name: 'eu_casino_broad_keywords_general' },
        { id: 'ag43', name: 'eu_slots_phrase_match_international' },
        { id: 'ag44', name: 'eu_casino_broad_keywords_general' },
        { id: 'ag45', name: 'eu_slots_phrase_match_international' },
        { id: 'ag46', name: 'eu_casino_broad_keywords_general' },
        { id: 'ag47', name: 'eu_slots_phrase_match_international' },
        { id: 'ag48', name: 'eu_casino_broad_keywords_general' },
        { id: 'ag49', name: 'eu_slots_phrase_match_international' },
      ]},
      { id: 'c3', name: 'Casino_Slots_Retargeting', status: 'active', appId: 'a3', adGroups: [
        { id: 'ag50', name: 'retargeting_lapsed_users_7days' },
        { id: 'ag51', name: 'retargeting_high_value_lookalike' },
        { id: 'ag52', name: 'retargeting_lapsed_users_7days' },
        { id: 'ag53', name: 'retargeting_high_value_lookalike' },
        { id: 'ag54', name: 'retargeting_lapsed_users_7days' },
        { id: 'ag55', name: 'retargeting_high_value_lookalike' },
        { id: 'ag56', name: 'retargeting_lapsed_users_7days' },
        { id: 'ag57', name: 'retargeting_high_value_lookalike' },
        { id: 'ag58', name: 'retargeting_lapsed_users_7days' },
        { id: 'ag59', name: 'retargeting_high_value_lookalike' },
      ]},
      { id: 'c4', name: 'Casino_High_Value_Users', status: 'active', appId: 'a1', adGroups: [
        { id: 'ag60', name: 'vip_exact_match_core_terms' },
        { id: 'ag61', name: 'whale_audience_broad_targeting' },
        { id: 'ag62', name: 'vip_exact_match_core_terms' },
        { id: 'ag63', name: 'whale_audience_broad_targeting' },
        { id: 'ag64', name: 'vip_exact_match_core_terms' },
        { id: 'ag65', name: 'whale_audience_broad_targeting' },
        { id: 'ag66', name: 'vip_exact_match_core_terms' },
        { id: 'ag67', name: 'whale_audience_broad_targeting' },
        { id: 'ag68', name: 'vip_exact_match_core_terms' },
        { id: 'ag69', name: 'whale_audience_broad_targeting' },
      ]},
      { id: 'c5', name: 'Casino_UK_Exact', status: 'paused', appId: 'a2', adGroups: [
        { id: 'ag70', name: 'uk_brand_exact_core_casino_terms' },
        { id: 'ag71', name: 'uk_slots_exact_competitor_keywords' },
        { id: 'ag72', name: 'uk_brand_exact_core_casino_terms' },
        { id: 'ag73', name: 'uk_slots_exact_competitor_keywords' },
        { id: 'ag74', name: 'uk_brand_exact_core_casino_terms' },
        { id: 'ag75', name: 'uk_slots_exact_competitor_keywords' },
        { id: 'ag76', name: 'uk_brand_exact_core_casino_terms' },
        { id: 'ag77', name: 'uk_slots_exact_competitor_keywords' },
        { id: 'ag78', name: 'uk_brand_exact_core_casino_terms' },
        { id: 'ag79', name: 'uk_slots_exact_competitor_keywords' },
      ]},
    ],
  },
  {
    ...
    campaigns: [
      { id: 'c6', name: 'Android_US_Brand', status: 'active', appId: 'a4', adGroups: [
        { id: 'ag80', name: 'android_us_brand_exact_match' },
        { id: 'ag81', name: 'android_us_competitor_broad_match' },
        { id: 'ag82', name: 'android_us_slots_high_intent' },
        { id: 'ag83', name: 'android_us_brand_exact_match' },
        { id: 'ag84', name: 'android_us_competitor_broad_match' },
        { id: 'ag85', name: 'android_us_slots_high_intent' },
        { id: 'ag86', name: 'android_us_brand_exact_match' },
        { id: 'ag87', name: 'android_us_competitor_broad_match' },
        { id: 'ag88', name: 'android_us_slots_high_intent' },
        { id: 'ag89', name: 'android_us_brand_exact_match' },
      ]},
      { id: 'c7', name: 'Android_Broad_Match', status: 'paused', appId: 'a5', adGroups: [
        { id: 'ag90', name: 'android_broad_casino_general_terms' },
        { id: 'ag91', name: 'android_broad_slots_phrase_match' },
        { id: 'ag92', name: 'android_broad_casino_general_terms' },
        { id: 'ag93', name: 'android_broad_slots_phrase_match' },
        { id: 'ag94', name: 'android_broad_casino_general_terms' },
        { id: 'ag95', name: 'android_broad_slots_phrase_match' },
        { id: 'ag96', name: 'android_broad_casino_general_terms' },
        { id: 'ag97', name: 'android_broad_slots_phrase_match' },
        { id: 'ag98', name: 'android_broad_casino_general_terms' },
        { id: 'ag99', name: 'android_broad_slots_phrase_match' },
      ]},
      { id: 'c8', name: 'Android_Remarketing', status: 'active', appId: 'a6', adGroups: [
        { id: 'ag100', name: 'android_retargeting_lapsed_30days' },
        { id: 'ag101', name: 'android_retargeting_vip_users_exact' },
        { id: 'ag102', name: 'android_retargeting_lapsed_30days' },
        { id: 'ag103', name: 'android_retargeting_vip_users_exact' },
        { id: 'ag104', name: 'android_retargeting_lapsed_30days' },
        { id: 'ag105', name: 'android_retargeting_vip_users_exact' },
        { id: 'ag106', name: 'android_retargeting_lapsed_30days' },
        { id: 'ag107', name: 'android_retargeting_vip_users_exact' },
        { id: 'ag108', name: 'android_retargeting_lapsed_30days' },
        { id: 'ag109', name: 'android_retargeting_vip_users_exact' },
      ]},
      { id: 'c9', name: 'Android_Competitor_KW', status: 'active', appId: 'a4', adGroups: [
        { id: 'ag110', name: 'android_competitor_brand_exact' },
        { id: 'ag111', name: 'android_competitor_generic_broad' },
        { id: 'ag112', name: 'android_competitor_brand_exact' },
        { id: 'ag113', name: 'android_competitor_generic_broad' },
        { id: 'ag114', name: 'android_competitor_brand_exact' },
        { id: 'ag115', name: 'android_competitor_generic_broad' },
        { id: 'ag116', name: 'android_competitor_brand_exact' },
        { id: 'ag117', name: 'android_competitor_generic_broad' },
        { id: 'ag118', name: 'android_competitor_brand_exact' },
        { id: 'ag119', name: 'android_competitor_generic_broad' },
      ]},
    ],
  },
  {
    ...
    campaigns: [
      { id: 'c10', name: 'EU_Brand_iOS', status: 'active', appId: 'a9', adGroups: [
        { id: 'ag120', name: 'eu_ios_brand_exact_match_terms' },
        { id: 'ag121', name: 'eu_ios_slots_phrase_match_broad' },
        { id: 'ag122', name: 'eu_ios_brand_exact_match_terms' },
        { id: 'ag123', name: 'eu_ios_slots_phrase_match_broad' },
        { id: 'ag124', name: 'eu_ios_brand_exact_match_terms' },
        { id: 'ag125', name: 'eu_ios_slots_phrase_match_broad' },
        { id: 'ag126', name: 'eu_ios_brand_exact_match_terms' },
        { id: 'ag127', name: 'eu_ios_slots_phrase_match_broad' },
        { id: 'ag128', name: 'eu_ios_brand_exact_match_terms' },
        { id: 'ag129', name: 'eu_ios_slots_phrase_match_broad' },
      ]},
      { id: 'c11', name: 'EU_Retargeting', status: 'active', appId: 'a7', adGroups: [
        { id: 'ag130', name: 'eu_retargeting_lapsed_users_14days' },
        { id: 'ag131', name: 'eu_retargeting_high_value_exact' },
        { id: 'ag132', name: 'eu_retargeting_lapsed_users_14days' },
        { id: 'ag133', name: 'eu_retargeting_high_value_exact' },
        { id: 'ag134', name: 'eu_retargeting_lapsed_users_14days' },
        { id: 'ag135', name: 'eu_retargeting_high_value_exact' },
        { id: 'ag136', name: 'eu_retargeting_lapsed_users_14days' },
        { id: 'ag137', name: 'eu_retargeting_high_value_exact' },
        { id: 'ag138', name: 'eu_retargeting_lapsed_users_14days' },
        { id: 'ag139', name: 'eu_retargeting_high_value_exact' },
      ]},
      { id: 'c12', name: 'UK_Exact_Match', status: 'paused', appId: 'a8', adGroups: [
        { id: 'ag140', name: 'uk_brand_exact_core_terms' },
        { id: 'ag141', name: 'uk_casino_exact_competitor_kw' },
        { id: 'ag142', name: 'uk_brand_exact_core_terms' },
        { id: 'ag143', name: 'uk_casino_exact_competitor_kw' },
        { id: 'ag144', name: 'uk_brand_exact_core_terms' },
        { id: 'ag145', name: 'uk_casino_exact_competitor_kw' },
        { id: 'ag146', name: 'uk_brand_exact_core_terms' },
        { id: 'ag147', name: 'uk_casino_exact_competitor_kw' },
        { id: 'ag148', name: 'uk_brand_exact_core_terms' },
        { id: 'ag149', name: 'uk_casino_exact_competitor_kw' },
      ]},
      { id: 'c13', name: 'DE_Broad_Search', status: 'active', appId: 'a7', adGroups: [
        { id: 'ag150', name: 'de_broad_casino_german_keywords' },
        { id: 'ag151', name: 'de_broad_slots_general_terms' },
        { id: 'ag152', name: 'de_broad_casino_german_keywords' },
        { id: 'ag153', name: 'de_broad_slots_general_terms' },
        { id: 'ag154', name: 'de_broad_casino_german_keywords' },
        { id: 'ag155', name: 'de_broad_slots_general_terms' },
        { id: 'ag156', name: 'de_broad_casino_german_keywords' },
        { id: 'ag157', name: 'de_broad_slots_general_terms' },
        { id: 'ag158', name: 'de_broad_casino_german_keywords' },
        { id: 'ag159', name: 'de_broad_slots_general_terms' },
      ]},
    ],
  },
];
